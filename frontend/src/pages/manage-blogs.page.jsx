      ...
      <section className='h-cover flex justify-center gap-10'>
        <div className='w-full'>
          ...
          <div className='relative max-md:mt-5 md:mt-8 mb-10'>
            ...
            />
            <i className='fi fi-rr-search absolute right-[10%] md:pointer-events-none md:left-5 top-1/2 -translate-y-1/2 text-xl text-xl text-dark-grey'></i>
          </div>

          <InPageNavigation
            routes={["Blogs Publicados", "Rascunhos"]}
            defaultHidden={["Blogs Publicados"]}
          >
            {blogs == null ? (
              <Loader />
              ...
              <>
                ...
                <LoadMoreDataBtn
                  ...
                  additionalParam={{
                    draft: false,
                    deleteDocCount: blogs.deletedDocCount,
                  }}
                />
              </>
            ) : (
              <NoDataMessage message='Nenhum blog publicado' />
            )}
            ...
            {drafts == null ? (
              ...
              <>
                ...
                <LoadMoreDataBtn
                  ...
                  additionalParam={{
                    draft: true,
                    deleteDocCount: drafts.deletedDocCount,
                  }}
                />
              </>
            ) : (
